...
<body>
	<div data-role="page">
		<div data-role="header" style="background-color:#6fd7ca; color:white;">
			...
			<p style="font-size:12px; float:right; margin:-28px 5px 0 0; font-weight:200;" onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/clear'">忽略全部</p>			
		</div>
		<div data-role="content">
		<?php if(is_array($dianzan)): $i = 0; $__LIST__ = $dianzan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div>
				<img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/tixing-zan.png">
			...
			<!-- <div>
				<img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/tixing-zan.png" style="margin:8px 0 0 0;">
