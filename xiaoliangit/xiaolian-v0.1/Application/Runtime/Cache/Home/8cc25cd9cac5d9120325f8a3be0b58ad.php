    ...
    <div data-role="page">
     <form method="post" action="/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/adddongtai" enctype="multipart/form-data">
        ...
        <div data-role="content">
                ...
                <div class="ui-field-contain">
                    <label for="info"></label>
                    <textarea cols="40" rows="18" name="content" id="info" value="">
                    说点什么吧……
                    </textarea>
          ...
          <!--   </form> -->
            ...
            <div style="width:300px;height:40px">
                <form method="post" action="" id="open">
                    <img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-shezhi-cam.png" style=" position:absolute; left:30px;top:180px;" height=40px>
                    <input type="file" style=" position:absolute; left:100px;top:180px;" value="选取文件">
                </form>
