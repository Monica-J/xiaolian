    ...
    <div data-role="page">
        ...
        <div data-role="content">
                ...
                <div class="ui-field-contain">
                    ...
                    <textarea cols="50" rows="5" id="textarea" onKeyDown="textdown(event)" onKeyUp="textup()" onfocus="if(value=='说点什么吧...100字以内哦'){value=''}" onblur="if (value ==''){value='说点什么吧...100字以内哦'}" >说点什么吧...100字以内哦</textarea>
          ...
          <!--   </form> -->
            ...
            <div style="width:300px;height:40px;">
                <form method="post" action="" id="open">
                    ...
                    <input type="file" style=" position:absolute; left:100px;top:170px;" value="选取文件">
                </form>             
            </div>
