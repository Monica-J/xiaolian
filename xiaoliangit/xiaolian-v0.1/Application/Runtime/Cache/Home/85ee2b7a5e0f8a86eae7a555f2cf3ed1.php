  ...
  <body>
	<div data-role="page">
		<div data-role="header">
			<a href="/xiaoliangit/xiaolian-v0.1/index.php/Home/index/index.html"  onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/index/index.html'" data-role="button" data-icon="arrow-l" data-iconpos="notext"></a>
		...
		<div data-role="content">
			...
			<div class="ui-grid-a" style="margin-top:10px;">
				<div class="ui-block-a" style="color:#8E8E8E;font-size:12px;font-weight:200;"> 
					<img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/index-activity-specific-like.png" style="width:30px;height:24px;"  onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/index/collection'">
