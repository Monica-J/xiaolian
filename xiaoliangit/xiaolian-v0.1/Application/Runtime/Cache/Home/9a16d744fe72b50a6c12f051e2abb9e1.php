...
<body> 
    <div data-role="page"> 
        <div data-role="header" data-position="fixed">              
            <a href="/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/haoyou.html" data-icon="arrow-l" data-iconpos="notext"></a>
            <!--用户部分信息-->
            <div class="user" style="height:200px; background:url(/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-bg.png);" >
                <br/>
                <br/>
                <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><img src="<?php echo ($url); echo ($u["userpic"]); ?>" width="90px" width="90px" style="clear: both; display: block; margin:auto;border-radius:50%">
            ...
            <!--历史动态-->
                <div style="margin:-10px 0 0 0;">     
                    <?php if(is_array($dynamic)): $i = 0; $__LIST__ = $dynamic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dy): $mod = ($i % 2 );++$i;?><div>
                        <img src="<?php echo ($url); echo ($dy["userpic"]); ?>" width="50px" height="50px" style="margin:10px 0 0 0;border-radius:50%" style="margin:10px 0 0 0;">
                        ...
                        <br/>
                        &nbsp;<img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-dianzan.png"><small style="color:#8E8E8E;font-size:12px;font-weight:200;"><?php echo ($dy["scantime"]); ?></small>
