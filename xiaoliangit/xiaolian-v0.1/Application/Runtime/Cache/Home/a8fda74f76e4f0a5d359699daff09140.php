    ...
    <div data-role="page"> 
        <div data-role="header" data-position="fixed">              
            ...
            <div data-role="navbar">
                <ul>
                    <li>
                        <a href="haoyou.html" onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/haoyou'" ><img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-haoyou.png" style="margin:4px 0 3px -50px;"><p style="margin:-24px 0 0 25px;">好友 <?php echo ($fc); ?></p></a>
                    </li>
                    <li>
                        <a href="shoucang.html" onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/shoucang'"><img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-shoucang.png" style="margin:4px 0 3px -50px;"><p style="margin:-24px 0 0 25px;">收藏 <?php echo ($cc); ?></p></a>
                    </li>
                    <li>
            ...
            <div style="margin:2px 0 0 0;">
                ...
                <div>
                    ...
                    <form style="margin:-55px 0 0 70px;">
                        ...
                        <a href="#page2" onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/dongtai'"><input type="text" name="text" id="text" placeholder="说说你想说的吧！" style="background:url(/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-talkbg.png);"></a>
                    </form>
                </div>
                ...
                <div>
                    ...
                    <?php if(is_array($dynamic)): $i = 0; $__LIST__ = $dynamic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><img src="<?php echo ($url); echo ($u["userpic"]); ?>" width="50px" height="50px" style="margin:10px 0 0 0;border-radius:50%">
                        ...
                        <a href="" onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/del/id/<?php echo ($d["id"]); ?>'"><p style="float:right; margin:1px 0 0 0; color:gray; font-size:6px;">删除</p></a>
                    ...
                    <!-- <div>
                        <img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-luser.png" style="margin:10px 0 0 0;">
