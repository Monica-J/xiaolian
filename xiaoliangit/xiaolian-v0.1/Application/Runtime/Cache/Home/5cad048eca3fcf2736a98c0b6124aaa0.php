...
<head>
	...
	<script src="/xiaoliangit/xiaolian-v0.1/Public/front/js/iscroll-zoom.js"></script>
	<script src="/xiaoliangit/xiaolian-v0.1/Public/front/js/hammer.js"></script>
	<script src="/xiaoliangit/xiaolian-v0.1/Public/front/js/jquery.photoClip.js"></script>
	<title>修改头像</title>
</head>
<body ontouchstart="">
	<div data-role="page">
		<div data-role="header" style="background-color:#6fd7ca; color:white;">
			<a href="/xiaoliangit/xiaolian-v0.1/index.php/Home/mine/shezhi.html" data-icon="arrow-l" data-iconpos="notext"></a>
