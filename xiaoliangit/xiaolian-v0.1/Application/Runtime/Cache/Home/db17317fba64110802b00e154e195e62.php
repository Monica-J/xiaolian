...
<head> 
    ...
    <!--弹出框插件css-->
    <link href="/xiaoliangit/xiaolian-v0.1/Public/front/css/normalize.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="/xiaoliangit/xiaolian-v0.1/Public/front/css/animate.min.css">
    <link rel="stylesheet" href="/xiaoliangit/xiaolian-v0.1/Public/front/css/jquery.gDialog.css">
    ...
    <!--弹出框插件js-->
    <script src="/xiaoliangit/xiaolian-v0.1/Public/front/js/jquery.gDialog.js"></script>
    <!--高德地图-->
    ...
    <div data-role="page">
       <div data-role="content">
            ...
            <div id="tip" style="float:right;">
                ...
                <button type="button" id="open" class="btn start" style="background:url(/xiaoliangit/xiaolian-v0.1/Public/front/images/task-start.png); width: 0px; float: right; margin: -35px 0 0 300px; border: none;"></button>
            </div>
       </div>
        ...
        <div data-role="footer" data-position="fixed"> 
            <div data-role="navbar">
              <ul>
                ...
                <li>
                    <a href="/xiaoliangit/xiaolian-v0.1/index.php/Home/indextask/task.html"  style="background-color:#6fd7ca;" onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/task/task.html'">
                ...
                <li>
                    <a href="/xiaoliangit/xiaolian-v0.1/index.php/Home/foot/foot.html"  style="background-color:#6fd7ca;" onclick="location.href='/xiaoliangit/xiaolian-v0.1/index.php/Home/foot/foot.html'">
