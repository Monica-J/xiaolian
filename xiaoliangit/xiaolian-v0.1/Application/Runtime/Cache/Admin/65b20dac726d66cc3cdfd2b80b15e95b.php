  ...
  <div class="row">
      <div class=" col-md-2 sidebar">
        <div id="accordion">
          ...
          <h3><a href="#"><span class="glyphicon glyphicon-star"></span>海报管理<span class="glyphicon glyphicon-chevron-down"></span></a></h3>
          <ul>            
            <li><a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/posters/posters_list.html">管理海报</a></li>
            <li><a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/posters/posters_add.html">添加海报</a></li>
          </ul>
        </div>
      </div>
    	<div class="col-md-10 col-md-offset-2 ">
    	  <ol class="breadcrumb">
    	    <li><a href="#">首页</a></li>
    	    <li><a href="#">任务管理</a></li>
    	    <li class="active">任务推荐</li>
  	    </ol>
    	  <div class="table-responsive ">
    	    <h3>任务推荐 <small>Tasks List</small></h3>
    	    <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table  table-striped table-hover ">
    	      ...
    	      <?php if(is_array($task)): $i = 0; $__LIST__ = $task;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><tr>
              <td><input type="checkbox" name="checkbox" id="checkbox"><label for="checkbox"></label></td>
              <td><?php echo ($t["taskname"]); ?></td>
              <td><?php echo ($t["initator"]); ?></td>
              <td><?php echo ($t["schoolname"]); ?></td>
              <td><?php echo ($t["tasktime"]); ?></td>
              <td><a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/task/task_edit/id/<?php echo ($t["id"]); ?>">修改</a><a href="#"></a> <a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/task/del/id/<?php echo ($t["id"]); ?>">删除</a></td>
    	  ...
    	  <div class="input-group pull-left form">
    	    <button type="submit" class="btn btn-danger "><a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/task/del/id/<?php echo ($u["id"]); ?>" style="color:white"> 删除</a></button>
  	    </div>
