...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  ...
  <div class="row">
      <div class=" col-md-2 sidebar">
        ...
        <h3 class="down">修改海报 <small>Posters Edit</small></h3>
        <div class="list-group form">
          <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" >
            <input type="hidden" name="id" value="<?php echo ($Posters["id"]); ?>" />
            <div class="list-group-item">
              <label for="inputEmail3" class="col-sm-2 control-label">海报名称</label>
              <div class="col-sm-10">
                <input type="input" name="pname" class="form-control" id="inputEmail3" placeholder="" value="<?php echo ($Posters["pname"]); ?>">
              </div>
            </div>
            <div class="list-group-item">
           ...
           <div class="list-group-item">
              <label for="inputEmail3" class="col-sm-2 control-label">修改海报</label>
              <div class="col-sm-10">
                <input type="file" name="img" class="form-control" id="inputEmail3" value="<?php echo ($Posters["img"]); ?>">
              </div>
            </div>
...
<?php echo ($posters["content"]); ?></textarea>
              </div>
            </div>
            <div class="list-group-item">
