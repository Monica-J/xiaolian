      ...
      <div class=" col-md-2 sidebar">
    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  ...
    	  <div class="table-responsive ">
    	    <h3>海报管理列表 <small>Posters List</small></h3>
    	    <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table  table-striped table-hover ">
    	      ...
    	      <?php if(is_array($Posters)): $i = 0; $__LIST__ = $Posters;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/posters/posters_edit/id/<?php echo ($p["id"]); ?>">修改</a><a href="#"></a> <a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/posters/del/id/<?php echo ($p["id"]); ?>">删除</a></td>
            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
  	      </table>
  	    </div>
    	  <div class="input-group pull-left form">
    	    <button type="submit" class="btn btn-danger "> <a href="/xiaoliangit/xiaolian-v0.1/index.php/Admin/posters/del/id/<?php echo ($u["id"]); ?>" style="color:white"> 删除</a></button>
  	    </div>
