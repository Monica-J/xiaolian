...
class Image{
    /* 驱动相关常量定义 */
    const IMAGE_GD              =   1; //常量，标识GD库类�?
    const IMAGE_IMAGICK         =   2; //常量，标识imagick库类�?

    /* 缩略图相关常量定�?*/
    const IMAGE_THUMB_SCALE     =   1 ; //常量，标识缩略图等比例缩放类�?
    const IMAGE_THUMB_FILLED    =   2 ; //常量，标识缩略图缩放后填充类�?
    const IMAGE_THUMB_CENTER    =   3 ; //常量，标识缩略图居中裁剪类型
    const IMAGE_THUMB_NORTHWEST =   4 ; //常量，标识缩略图左上角裁剪类�?
    const IMAGE_THUMB_SOUTHEAST =   5 ; //常量，标识缩略图右下角裁剪类�?
    ...
    const IMAGE_WATER_CENTER    =   5 ; //常量，标识居中水�?
    ...
    /**
     * 构造方法，用于实例化一个图片处理对�?
     * @param string $type 要使用的类库，默认使用GD�?
     */
    ...
    /**
     * 生成缩略�?
     * @param  integer $width  缩略图最大宽�?
     * @param  integer $height 缩略图最大高�?
     * @param  integer $type   缩略图裁剪类�?
     * @return Object          当前图片处理库对�?
     */
