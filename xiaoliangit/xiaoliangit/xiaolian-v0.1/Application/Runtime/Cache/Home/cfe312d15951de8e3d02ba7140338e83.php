...
<body>
	<div data-role="page">
		...
		<div data-role="content">
			<?php if(is_array($dynamic)): $i = 0; $__LIST__ = $dynamic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div style="margin:0px 0 0 0;">
				<h5>文字动态</h5>
                <br/>
				<div>
                    ...
                    <div class="content">
                    	<br/>
                        <p style="margin:10px 0 0 20px;"><?php echo ($d["content"]); ?></p>                       
                        &nbsp;<img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-dianzan.png" style="margin-top:12px;"><small style="color:#8E8E8E;font-size:12px;font-weight:200;"><?php echo ($d["scantime"]); ?></small>
                ...
                <!-- <div>
                    ...
                    <div class="content">
                        ...
                        &nbsp;<a href=""><img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-dianzan.png" style="margin-top:12px;"></a>
                        &nbsp;<a href=""><img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-pinglun.png"></a>
                        &nbsp;<a href=""><img src="/xiaoliangit/xiaolian-v0.1/Public/front/images/mine-zhuanfa.png"></a>
                    </div>
                </div>
