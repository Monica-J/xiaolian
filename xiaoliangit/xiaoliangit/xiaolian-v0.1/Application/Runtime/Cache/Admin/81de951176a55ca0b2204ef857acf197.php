        ...
        <div class="list-group form">
          <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" >
            ...
            <div class="list-group-item">
              ...
              <div class="col-sm-10"><input type="input" name="schoolname" class="form-control" id="inputEmail3" value="<?php echo ($news["schoolname"]); ?>" ></div>
            </div>
           
            <div class="list-group-item">
              <label for="inputEmail3" class="col-sm-2 control-label">发布人/作者</label>
              <div class="col-sm-10">
                <input type="input" name="author" class="form-control" id="inputEmail3" value="<?php echo ($news["author"]); ?>">
              </div>
            </div>
           ...
           <div class="list-group-item">
              ...
              <div class="col-sm-10">
                <input type="file" name="newspic" class="form-control" id="inputEmail3" value="<?php echo ($news["newspic"]); ?>">
              </div>
            </div>
