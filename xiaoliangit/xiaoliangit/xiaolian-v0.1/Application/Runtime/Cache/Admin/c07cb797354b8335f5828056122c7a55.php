  ...
  <div class="row">
      <div class=" col-md-2 sidebar">
    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  ...
    	  <h3 class="down">添加海报 <small>Posters Add</small></h3>
    	  <div class="list-group form">
    	    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="/xiaoliangit/xiaolian-v0.1/index.php/Admin/posters/doAdd">
    	      <div class="list-group-item">
    	        <label for="inputEmail3" class="col-sm-2 control-label">海报名称</label>
    	        <div class="col-sm-10">
    	          <input type="input" class="form-control" id="inputEmail3" placeholder="" name="pname">
  	          </div>
  	        </div>
    	      <div class="list-group-item">
            ...
            <div class="list-group-item">
              <label for="inputEmail3" class="col-sm-2 control-label">添加海报</label>
              <div class="col-sm-10">
              ...
              <div class="row">
    	        <div class=" col-sm-5">
    	          <button type="submit" class="btn btn-primary">添 加 海 报</button>
  	          </div>
              <div class=" col-sm-5">
