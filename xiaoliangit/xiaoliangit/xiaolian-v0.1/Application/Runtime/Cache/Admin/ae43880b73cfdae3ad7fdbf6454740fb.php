            ...
            <div class="list-group-item">
              <form role="form" method="post" action="/xiaoliangit/xiaolian-v0.1/index.php/Admin/User/user_edit/id/1">
                ...
                <div class="input-group "> <span class="input-group-addon" for="inputWarning1">真实姓名：</span>
                  <input type="text" name="realname" value="<?php echo ($users["realname"]); ?>" class="form-control" id="input">
                </div>
                <div class="input-group"> <span class="input-group-addon">密码：</span>
                  <input type="text" name="password" value="<?php echo ($users["password"]); ?>" class="form-control" placeholder="<?php echo ($users["password"]); ?>">
                </div>
                <div class="input-group"> <span class="input-group-addon">手机号码：</span>
                  <input type="text" name="tel" value="<?php echo ($users["tel"]); ?>" class="form-control" placeholder="<?php echo ($users["tel"]); ?>">
                  
                </div>
                <div class="input-group"> <span class="input-group-addon">电子邮箱：</span>
                  <input type="text" name="email" value="<?php echo ($users["email"]); ?>" class="form-control" placeholder="">
                </div>
                <div class="input-group"> <span class="input-group-addon">注册时间：</span>
                  <input type="text" name="addtime" value="<?php echo ($users["addtime"]); ?>" class="form-control" placeholder="2014-05-22" readonly>
                </div>
                <div class="input-group">
                  <input type="submit" name="submit" class="btn btn-primary " value="保&nbsp;&nbsp;存"> 
                </div>
              </form>
            </div>
          </div>
