		...
		<div data-role="content">
			...
			<div style="margin:-30px 0 0 0;">
                ...
                <?php if(is_array($dynamic)): $i = 0; $__LIST__ = $dynamic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div>
                    <img src="<?php echo ($d["userpic"]); ?>"  width="50px" height="50px" style="margin:10px 0 0 0;border-radius:50%">
                    ...
                    <div class="content">
                        ...
                        <img src="<?php echo ($d["pic"]); ?>" width="300px" height="150px" style="margin:6px 0 0 20px;">
                        </div>
                        <br/>
                        &nbsp;<img src="/Public/front/images/mine-dianzan.png" onclick="location.href='/index.php/Home/kankan/dianzan/id/<?php echo ($d["id"]); ?>'"><small style="color:#8E8E8E;font-size:12px;font-weight:200;"><?php echo ($d["scantime"]); ?></small>
                   ...
                   <!--  <img src="/Public/front/images/longline.png" style="margin:0 0 0 -15px; width:1500px; ">
                    ...
                    <div>
                    <img src="/Public/front/images/kankan-user.png" style="margin:10px 0 0 0;">
