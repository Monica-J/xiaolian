...
<body>
	<div data-role="page">
		...
		<div data-role="content">
			<div>
			<?php if(is_array($friends)): $i = 0; $__LIST__ = $friends;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f): $mod = ($i % 2 );++$i;?><a href="/index.php/Home/mine/grzl/id/<?php echo ($f["id"]); ?>" onclick="location.href='/index.php/Home/mine/grzl/id/<?php echo ($f["id"]); ?>'"><img src="<?php echo ($f["pic"]); ?>" width="50px" height="50px" style="margin:10px 0 0 0;border-radius:50%"></a>
				...
				<img src="/Public/front/images/longline.png" style="margin:20px 0 0 -15px;"><?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
			<!-- <div>
				<a href="/index.php/Home/mine/grzl.html"><img src="/Public/front/images/haoyou-user.png" style="margin:10px 0 0 0;"></a>
