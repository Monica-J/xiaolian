...
<head>
    ...
    <script src="/Public/front/js/action-sheet.js"></script>
    <style>
        body{
            margin: 0;
            text-align: center;
...
<body>
	<div data-role="page">
		...
		<div data-role="header" style="background-color:#6fd7ca; color:white;">
			<a href="/index.php/Home/mine/mine.html"  onclick="location.href='/index.php/Home/mine/mine'" data-icon="arrow-l" data-iconpos="notext"></a>
		...
		<div data-role="content" style="overflow-x:visible;">
			<div class="user" style="height:200px;">
                <!--实现点击头像或者相机可以更改头像-->
	            <div class="avatar"> 
	            <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><img src="<?php echo ($u["userpic"]); ?>"  width="90px" height="90px" style="margin:10px 0 0 0;border-radius:50%" style="clear:both; display: block; margin:auto;">
	                <a href=""><button type="button" id="open" style="background:url(/Public/front/images/mine-shezhi-cam.png); width:10px; margin:-25px 0 0 200px; border:none;"></button></a>
	            </div>

	           <div class="infor">
	           
	            	<form method="post" action="/index.php/Home/mine/xiugai" style="margin:50px 0 0 0;">						
						<div>
							...
							<div class="ui-grid-a">
								<div class="ui-block-a">
									<img src="/Public/front/images/mine-shezhi-sex.png" style="float:left; margin:14px 0 0 0;">
							...
							<div class="ui-grid-a">
								<div class="ui-block-a">
									<img src="/Public/front/images/mine-shezhi-birth.png" style="float:left; margin:14px 0 0 0;">
							...
							<div class="ui-grid-a">
								<div class="ui-block-a">
									<img src="/Public/front/images/mine-shezhi-univer.png" style="float:left; margin:14px 0 0 0;">
							...
							<div class="ui-grid-a">
								<div class="ui-block-a">
									<img src="/Public/front/images/mine-shezhi-gq.png" style="float:left; margin:14px 0 0 0;">
