...
<head> 
    ...
    <!--弹出框插件css-->
    <link href="/Public/front/css/normalize.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="/Public/front/css/animate.min.css">
    <link rel="stylesheet" href="/Public/front/css/jquery.gDialog.css">

    <script src="/Public/front/js/jquery-2.2.2.js"></script>
    <script src="/Public/front/js/jquery.mobile-1.4.5.min.js"></script>    
    <!--弹出框插件js-->
    <script src="/Public/front/js/jquery.gDialog.js"></script>
    <!--高德地图-->
...
<body>  
    <div data-role="page">
       <div data-role="content">
            ...
            <!--返回定位信息暂时隐藏-->
            <!--<div id="tip1" style=""></div>-->
            <div id="tip" style="float:right;">
                <input type="text" id="keyword" name="keyword" value="请输入关键字：(选定后搜索)" onfocus='this.value=""'/ style="">
                <button type="button" id="open" class="btn start" style="background:url(/Public/front/images/task-start.png); width: 0px; float: right; margin: -35px 0 0 300px; border: none;"></button>
            </div>
       </div>
        ...
        <div data-role="footer" data-position="fixed"> 
            <div data-role="navbar">
              <ul>
                <li>
                    <a href="/index.php/Home/index/index.html" onclick="location.href='/index.php/Home/index/index.html'" style="background-color:#6fd7ca;">
                ...
                <li>
                    <a href="/index.php/Home/indextask/task.html"  style="background-color:#6fd7ca;" onclick="location.href='/index.php/Home/task/task.html'">
                ...
                <li>
                    <a href="/index.php/Home/kankan/kankan.html" onclick="location.href='/index.php/Home/kankan/kankan.html'" style="background-color:#6fd7ca;">
                ...
                <li>
                    <a href="/index.php/Home/foot/foot.html"  style="background-color:#6fd7ca;" onclick="location.href='/index.php/Home/foot/foot.html'">
                ...
                <li>
                    <a href="/index.php/Home/mine/mine.html"  style="background-color:#6fd7ca;">
                        <img src="/Public/front/images/wode.png" style="width:24px; height:24px;">
