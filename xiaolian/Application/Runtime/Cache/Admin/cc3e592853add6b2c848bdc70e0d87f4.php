  ...
  <div class="row">
      ...
      <div class="col-md-10 col-md-offset-2 ">
        <ol class="breadcrumb">
          <li><a href="#">首页</a></li>
          <li><a href="#">大学管理</a></li>
          <li class="active">添加大学</li>
        </ol>
        <div class="table-responsive ">
          <h3>添加大学 <small>School Edit</small></h3>
         <div class="list-group form">
          <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="/xiaolian-git/xiaolian-v0.1/index.php/Admin/school/doAdd">
            <div class="list-group-item">
              <label for="inputEmail3" class="col-sm-2 control-label">大学名称</label>
              <div class="col-sm-10">
                <input type="input" class="form-control" id="inputEmail3" placeholder="" name="sname" >
              </div>
            </div>
            ...
            <div class="list-group-item">
              ...
              <div class="col-sm-10">
                <input type="input" class="form-control" id="inputEmail3" placeholder="" name="splace" value="">
              </div>
            </div>
