...
;(function($) {
    ...
    $.sangarSlider.defaults = {
        ...
        width : 1500, // slideshow base width
        height : 800, // slideshow base height
        fullWidth : true, // slideshow width (and height) will scale to the container size使其铺满整个宽度
        fullHeight : false, // slideshow height will resize to browser height
        minHeight : 195, // slideshow min height 设置最小高度 当屏幕是更大尺寸时高度自适应
