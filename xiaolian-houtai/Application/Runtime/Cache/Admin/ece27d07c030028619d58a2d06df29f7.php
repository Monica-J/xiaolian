	...
	<div class="row">
    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  <ol class="breadcrumb">
    	    ...
    	    <li><a href="/xiaolian/thinkphp_3.2.3/index.php/Admin">新闻管理</a></li>
    	    <li class="active">添加新闻</li>
  	    </ol>
    	  <h3 class="down">添加新闻 <small>News Add</small></h3>
    	  <div class="list-group form">
    	    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="/xiaolian/thinkphp_3.2.3/index.php/Admin/news/doAdd">
