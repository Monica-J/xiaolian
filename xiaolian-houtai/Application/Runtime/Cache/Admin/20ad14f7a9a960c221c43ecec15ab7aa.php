  ...
  <div class="row">
      <div class=" col-md-2 sidebar">
    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  <ol class="breadcrumb">
    	    <li><a href="/xiaolian/thinkphp_3.2.3/index.php/Admin">首页</a></li>
    	    <li><a href="/xiaolian/thinkphp_3.2.3/index.php/Admin">任务管理</a></li>
    	    <li class="active">添加任务</li>
  	    </ol>
    	  <h3 class="down">添加任务 <small>Tasks Add</small></h3>
    	 
   	
      <div class="list-group form">
          <form enctype="multipart/form-data" class="form-horizontal" role="form" method="post" action="/xiaolian/thinkphp_3.2.3/index.php/Admin/task/doAdd">
            <div class="list-group-item">
              <label for="inputEmail3" class="col-sm-2 control-label">任务名称</label>
              <div class="col-sm-10">
                <input type="input" class="form-control" id="inputEmail3" placeholder="" name="taskname">
              </div>
            </div>
            <div class="list-group-item">
              <label for="inputEmail3" class="col-sm-2 control-label">发起人</label>
              <div class="col-sm-10">
                <input type="input" class="form-control" id="inputEmail3" placeholder="" name="initator">
              </div>
            </div>
            <div class="list-group-item">
            ...
            <div class="list-group-item">
              ...
              <div class="col-sm-10">
                <input type="input" class="form-control" id="inputEmail3" placeholder="" name="schoolname">
              </div>
            </div>
