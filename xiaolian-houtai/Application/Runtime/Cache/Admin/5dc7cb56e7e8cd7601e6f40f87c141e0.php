    	...
    	<div class="col-md-10 col-md-offset-2 ">
    	  ...
    	  <div class="table-responsive ">
    	    ...
    	    <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table  table-striped table-hover ">
              ...
              <td><a href="/xiaolian/thinkphp_3.2.3/index.php/Admin/News/news_edit/id/<?php echo ($d["id"]); ?>">修改</a><a href="#"></a> <a href="/xiaolian/thinkphp_3.2.3/index.php/Admin/News/del/id/<?php echo ($d["id"]); ?>">删除</a></td>
            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
  	      </table>
  	    </div>
    	  <div class="input-group pull-left form">
    	    <button type="submit" class="btn btn-danger "> <a href="/xiaolian/thinkphp_3.2.3/index.php/Admin/news/del/id/<?php echo ($u["id"]); ?>" style="color:white"> 删除</a></button>
  	    </div>
