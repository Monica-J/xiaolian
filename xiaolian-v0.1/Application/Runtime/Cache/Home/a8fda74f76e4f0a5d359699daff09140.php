...
<<<<<<< HEAD
            <div class="user" style="height:200px; background:url(/xiaolian/xiaolian-v0.1/Public/front/images/mine-bg.png);" >
                <a href="/xiaolian/xiaolian-v0.1/index.php/Home/denglu/enter.html"><button type="button" id="open" style="background:url(/xiaolian/xiaolian-v0.1/Public/front/images/mine-logout.png); width:25px; height:25px; float:left; margin-left:7px; border:none;"></button></a>
                <a href="/xiaolian/xiaolian-v0.1/index.php/Home/mine/shezhi.html"><img src="/xiaolian/xiaolian-v0.1/Public/front/images/mine-shezhi.png" style="float:right; margin:5px 5px 0 0;"></a>
                <br/>
                <br/>
...
<<<<<<< HEAD
                    ...
                    <li>
                        <a href="chengjiu.html"><img src="/xiaolian/xiaolian-v0.1/Public/front/images/mine-chengjiu.png" style="margin:4px 0 3px -50px;"><p style="margin:-24px 0 0 25px;">成就 5</p></a>
                    </li>
                    <li>
