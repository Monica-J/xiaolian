...
<<<<<<< HEAD
                    ...
                    <li>
                        <a href="shoucang.html"><img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-shoucang.png" style="margin:4px 0 3px -50px;"><p style="margin:-24px 0 0 25px;">收藏 8</p></a>
                    </li>
                    <li>
                        <a href="chengjiu.html"><img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-chengjiu.png" style="margin:4px 0 3px -50px;"><p style="margin:-24px 0 0 25px;">成就 2</p></a>
                    </li>
                    <li>
...
<<<<<<< HEAD
                    ...
                    <form style="margin:-55px 0 0 70px;">
                        ...
                        <a href="#page2"><input type="text" name="text" id="text" placeholder="说说你想说的吧！" style="background:url(/xiaolian/xiaolian-v0.1/Public/front/images/mine-talkbg.png);"></a>
                    </form>
                </div>
...
=======
                    ...
                    <form style="margin:-55px 0 0 70px;">
                        <label for="text"></label>
                        <a href="#page2"><input type="text" name="text" id="text" placeholder="说说你想说的吧！" style="background:url(/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-talkbg.png);"></a>
                    </form>
                </div>
