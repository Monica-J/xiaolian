...
=======
            <div class="user" style="height:200px; background:url(/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-bg.png);" >
                <button type="button" id="open" style="background:url(/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-logout.png); width:25px; height:25px; float:left; margin-left:7px; border:none;"></button>
