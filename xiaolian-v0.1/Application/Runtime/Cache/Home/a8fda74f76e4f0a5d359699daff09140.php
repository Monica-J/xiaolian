        ...
        <div data-role="header" data-position="fixed">              
            ...
            <div data-role="navbar">
                <ul>
                    ...
                    <li>
                        <a href="chengjiu.html"><img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-chengjiu.png" style="margin:4px 0 3px -50px;"><p style="margin:-24px 0 0 25px;">成就 0</p></a>
                    </li>
                    <li>
