...
<body>
    <div data-role="page">
        ...
        <div class="line1">
                <img src="/xiaolianV0.1/xiaolian-v0.1/Public/front/images/zc-phone.png">
        ...
        <div class="chose">
                ...
                <a  href="register1.html" data-rel="dialog" data-ajax="false"  data-role="none" class="login" data-theme="b" style="background-color:#6fd7ca; border:none; font-color:white;">注册</a>
        </div>
