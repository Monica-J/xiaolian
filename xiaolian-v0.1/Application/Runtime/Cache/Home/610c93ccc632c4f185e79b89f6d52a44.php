...
<body> 
    <div data-role="page"> 
        <div data-role="header" data-position="fixed">              
            <a href="/xiaolianV0.1/xiaolian-v0.1/index.php/Home/mine/haoyou.html" data-icon="arrow-l" data-iconpos="notext"></a>
            <!--用户部分信息-->
            <div class="user" style="height:200px; background:url(/xiaolianV0.1/xiaolian-v0.1/Public/front/images/mine-bg.png);" >
                <br/>
                <br/>
                <img src="/xiaolianV0.1/xiaolian-v0.1/Public/front/images/hydt-user.png" style="clear: both; display: block; margin:auto;">
