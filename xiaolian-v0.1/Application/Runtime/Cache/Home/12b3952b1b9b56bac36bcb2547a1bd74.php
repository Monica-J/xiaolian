  ...
  <body>
	<div data-role="page">
		<div data-role="header" style="background-color:#6fd7ca;color:#fff;">
			<a href="/xiaolianV0.1/xiaolian-v0.1/index.php/Home/kankan/hydt.html" data-role="button" data-icon="arrow-l" data-iconpos="notext"></a>
		...
		<div class="user" style="height:200px; background:url(/xiaolianV0.1/xiaolian-v0.1/Public/front/images/mine-bg.png);" >
            <br/>
            <br/>
            <a href="#"><img src="/xiaolianV0.1/xiaolian-v0.1/Public/front/images/hydt-user.png" style="clear: both; display: block; margin:auto;"></a>
