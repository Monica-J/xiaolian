...
>>>>>>> 01b57ce9fa315e0ea71222318892f143ea1e8fb8
			...
			<p style="font-size:12px; float:right; margin:-28px 5px 0 0; font-weight:200;">忽略全部</p>			
		</div>
		<div data-role="content">
			<div>
<<<<<<< HEAD
				<img src="/xiaolian/xiaolian-v0.1/Public/front/images/tixing-zan.png">
			...
			<div>
				<img src="/xiaolian/xiaolian-v0.1/Public/front/images/tixing-zan.png" style="margin:8px 0 0 0;">
				<p style="margin:-34px 0 0 50px;">你被李真心自由赞了</p>
				<img src="/xiaolian/xiaolian-v0.1/Public/front/images/longline.png" style="margin:20px 0 0 -15px;">
			</div>
			<div>
			...
			<div>
				...
				<img src="/xiaolian/xiaolian-v0.1/Public/front/images/longline.png" style="margin:20px 0 0 -15px;">
=======
				<img src="/xiaolianV0.1/xiaolian-v0.1/Public/front/images/tixing-zan.png">
				<p style="margin:-34px 0 0 50px;">你被李真心自由赞了</p>
				<img src="/xiaolianV0.1/xiaolian-v0.1/Public/front/images/longline.png" style="margin:20px 0 0 -15px;">
			</div>
			<div>
				<img src="/xiaolianV0.1/xiaolian-v0.1/Public/front/images/tixing-zan.png" style="margin:8px 0 0 0;">
				<p style="margin:-34px 0 0 50px;">你被李真心自由赞了</p>
				<img src="/xiaolianV0.1/xiaolian-v0.1/Public/front/images/longline.png" style="margin:20px 0 0 -15px;">
			</div>
			<div>
