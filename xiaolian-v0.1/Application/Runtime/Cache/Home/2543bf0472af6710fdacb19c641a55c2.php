<?php if (!defined('THINK_PATH')) exit();?>  <!DOCTYPE html>
 ...
 <head>
    ...
    <link rel="stylesheet" type="text/css" href="/xiaolian-git/xiaolian-v0.1/Public/front/css/shezhi-style.css">   
		       ...
		       <div data-role="content" style="overflow-x:visible;">
                ...
                <!--实现点击头像或者相机可以更改头像-->
	                  <div class="avatar">    
                        ...
                        <div class="line1">
                              <img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-shezhi-uname.png">
                        ...
                        <div class="line4">
                               <img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-shezhi-univer.png">
                               <input type="text"  id="daxue" class="daxue" value="大学" onfocus="if(value=='大学') {value=''}" onblur="if (value=='') {value='大学'}" data-role="none">
                        </div>

                        <div class="line5">
                               <img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/mine-shezhi-gq.png">
