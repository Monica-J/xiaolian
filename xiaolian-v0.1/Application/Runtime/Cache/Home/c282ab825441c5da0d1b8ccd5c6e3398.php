...
=======
                <a href="/xiaolian-git/xiaolian-v0.1/index.php/Home/mine/activity-specific.html" style="text-decoration:none;">
                	<span>
            ...
            <div>
                <a href="/xiaolian/xiaolian-v0.1/index.php/Home/mine/activity-specific.html" style="text-decoration:none;">
                	<span>
                		<img src="/xiaolian/xiaolian-v0.1/Public/front/images/index-activity.png" style="width:100%">
=======
            <img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/longline.png" style="margin:-10px 0 10px -15px";>
            <div>
                <a href="/xiaolian-git/xiaolian-v0.1/index.php/Home/mine/activity-specific.html" style="text-decoration:none;">
                	<span>
                		<img src="/xiaolian-git/xiaolian-v0.1/Public/front/images/index-activity.png" style="width:100%">
