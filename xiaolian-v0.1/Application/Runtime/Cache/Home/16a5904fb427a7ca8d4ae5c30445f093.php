	...
	<div data-role="page">
		...
		<div data-role="content">
			...
			<div class="panel-1" style="margin-bottom: -10px">
				<a href="/xiaolian/xiaolian-v0.1/index.php/Home/index/activity-specific.html" onclick="location.href='/xiaolian/xiaolian-v0.1/index.php/Home/index/activity-specific.html'" style="text-decoration:none;">
                    <span><img src="/xiaolian/xiaolian-v0.1/Public/front/images/index-activity.png" style="width:100%">
                    <p style="color:#8E8E8E;">河北师范大学2016年度迎新送老晚会将于9月23日在软件楼门口举行，届时将会有精彩的演出，欢迎同学们前来观看</p>
                	</span>
                </a>
			</div>
			<img src="/xiaolian/xiaolian-v0.1/Public/front/images/longline.png" style="width:1500px;height:1px;margin-left:-20px;">
